...
pcaPlotStSpc = 0;   % Will plot neural state space if True
...
S.Uslop  = 2.5;   % Slope of the linear urgency function 
...
if pcaPlotStSpc; stateSpace(FR,pcaPlotComps,pcaPlotConds); end
