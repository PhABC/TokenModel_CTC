...
%npref
plot(mean(C.PMd(npref,:,1)),'.b','LineWidth',1)
plot(mean(C.PMd(npref,:,2)),'.r','LineWidth',1)
plot(mean(C.PMd(npref,:,3)),'.g','LineWidth',1)
ylim([5,100])
title('PMd')
%% M1
...
%npref
plot(mean(C.M1(npref,:,1)),'.b','LineWidth',1)
plot(mean(C.M1(npref,:,2)),'.r','LineWidth',1)
plot(mean(C.M1(npref,:,3)),'.g','LineWidth',1)
ylim([5,100])
title('M1')
